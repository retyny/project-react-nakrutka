...
import {viewsPricesProductsDiscountInstagram} from "../../constant";

const ViewsInstagramServices = () => {
    return (
        <div className={'shop-cards-wrapper'}>
            {
                viewsPricesProductsDiscountInstagram.map((card) =>
...
export default ViewsInstagramServices;